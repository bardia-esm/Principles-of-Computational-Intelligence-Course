...
def load_hoda(training_sample_size=50000, test_sample_size=10000, size=9):
    #load dataset
    ...
    #reshape
    X_train = [x.reshape(size*size) for x in X_train_9by9]
    X_test = [x.reshape(size*size) for x in X_test_9by_9]
